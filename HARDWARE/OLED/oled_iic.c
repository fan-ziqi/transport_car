...
void show_bmp(u8 a)
{
	switch(a)
	{
		...
		case 100:
			OLED_DrawBMP(32,3,96,7,B100);
		break;
		
		case 90:
			OLED_DrawBMP(32,3,96,7,B90);
		break;
		
		case 80:
			OLED_DrawBMP(32,3,96,7,B80);
		break;
		
		case 70:
			OLED_DrawBMP(32,3,96,7,B70);
		break;
		
		case 60:
			OLED_DrawBMP(32,3,96,7,B60);
		break;
		
		case 50:
			OLED_DrawBMP(32,3,96,7,B50);
		break;
		
		case 40:
			OLED_DrawBMP(32,3,96,7,B40);
		break;
		
		case 30:
			OLED_DrawBMP(32,3,96,7,B30);
		break;
		
		case 20:
			OLED_DrawBMP(32,3,96,7,B20);
		break;
		
		case 10:
			OLED_DrawBMP(32,3,96,7,B10);
		break;
		
		case 0:
			OLED_DrawBMP(32,3,96,7,B0);
		break;
		
		case 111:
			OLED_DrawBMP(32,3,96,7,BCLR);
		break;
